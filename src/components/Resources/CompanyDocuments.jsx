        ...
        <div class="overflow-hidden border border-gray-200 w-full bg-white md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 ">
                ...
                <tbody class="bg-white divide-y divide-gray-200 ">
                    <tr>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">Board meeting document.xlsx</td>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">Compliance</td>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">12/03/2023</td>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">John Doe</td>
                    </tr>
                    <tr>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">Board meeting document.xlsx</td>
                        <td class="p-4 text-dark text-sm font-medium whitespace-nowrap">Compliance</td>
