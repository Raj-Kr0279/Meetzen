...
const Dashboard = () => {
 ...
 return <div className="grid dash__wrapper px-4 md:px-10 py-4 grid-cols-1 md:grid-cols-[1.5fr_1fr] pb-20 gap-8">
              ...
              <div className="flex items-start">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-light text-smallSubheading text__content_dash">
                    ...
                    Similique ipsa repellat suscipit optio ex, voluptates quos
                    nihil sunt consequuntur voluptate?
                  </span>
                </div>
              </div>
            </div>
