...
import { AiFillWarning, AiOutlineInfoCircle, AiOutlineWarning } from 'react-icons/ai';
...
const CompanyRegistration = () => {
  ...
  return (
    <div className="grid-cols-1 md:grid-cols-2 grid w-full h-screen">
        <form action="" onSubmit={handleSubmit} className="w-full">
          <div className="flex flex-col gap-2 pb-16">
            ...
            >
              ...
              <a className="my-anchor-element inline-block ml-2 cursor-pointer"> <AiOutlineInfoCircle /></a>
            ...
            <input
              ...
              name="company_code"
              id="company_code"
              className={`${!inputError ? 'border-error' : "border"} border-1 text-paragraph  focus-within:border-dark focus-within:outline-none py-3 px-4 rounded-md`}
      ...
      {/*Tooltip component */}
      <Tooltip
        style={{ backgroundColor: "white", color: "#919BA7", width: "250px", boxShadow: "0px 6px 7px 0px #e5e5e5" }}
        anchorSelect=".my-anchor-element" className='tooltip bg-white text-black text-smallCaption' place="bottom-start">
        To add a new company please enter the 8 digit company registration code shared by your company secretary and click on go
      </Tooltip>
    </div>
  );
};
