            ...
            <div className="flex items-start">
                ...
                <div className="flex flex-col">
                    <div className="flex justify-between leading-none pb-1 items-center">
                        <p className='text-body-sm'>Brenda White</p>
                        <span className="text-captionLight">12:00</span>
                    </div>
                    <span className='text-captionLight text-muted leading-[1.3]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique ipsa repellat suscipit optio ex, voluptates quos nihil sunt consequuntur voluptate?</span>
                </div>
        ...
        <>
          {/* <PageHeading label = "Chat"/> */}
            ...
            <div className="flex w-full h-full">
                <div className='border-r flex flex-col border-r-border basis-[300px] twok:basis-[450px] shrink-0 pr-2'>
                    <div className='flex items-center pt-4 pb-2 justify-between'>
                        ...
                        <button className="bg-primarytext-mono-sm text-white px-4 py-2 font-medium rounded-md flex items-center gap-2" onClick={()=>setAddMemberModal(!addMemberModal)}>Add<AiOutlinePlus className=" text-mediumSubheading" /></button>
                    ...
                    <div className="overflow-y-scroll grow chat_left pb-4">
                ...
                <div className='grow flex-1 flex flex-col shrink-0'>
                    ...
                    <div className="chat__area flex flex-col gap-5 grow overflow-y-auto wrap-break-word py-6 px-8">
                        ...
                        <div className='flex ml-auto w-[65%] flex-row-reverse items-start'>
                            ...
                            <div className=' mx-4'>
                                ...
                                <span className='text-mono-sm text-placeholder flex justify-end pt-2 font-normal'>08:15 PM</span>
                            </div>
                        </div>
                        <div className='flex w-[65%] items-start mb-auto'>
                            <div className="relative w-10 h-10 shrink-0 mr-4">
                            ...
                            <div className=' mx-4'>
                                ...
                                <span className='text-mono-sm text-placeholder font-normal'>08:15 PM</span>
                            </div>
                        </div>
                        <div className='flex ml-auto w-[65%] flex-row-reverse items-start'>
                            <div className="relative w-10 h-10 shrink-0 mr-4">
                    ...
                    <div className="flex w-full py-4 px-8 bg-chatInput items-center gap-4">
                        ...
                        <div className='relative w-full'>
                            ...
                            <div className={`${attatchModal ? "flex" : "hidden"} absolute bottom-full mb-2 bg-white shadow-filter py-2 rounded-sm right-0 flex-col`}>
                                <div className="flex items-center gap-1 py-2 border-b border-profileModalBorder px-4"><img src={gallery} className='w-[16px] h-auto ' alt="" /><span className='text-mono-sm font-normal text-prof' >Photos & Videos</span></div>
                                <div className="flex items-center gap-1 py-2 px-4"><img src={doc} className='w-[16px] h-auto ' alt="" /><span className='text-mono-sm font-normal text-prof' >Document</span></div>
                            </div>
