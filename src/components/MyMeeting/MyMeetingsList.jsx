  ...
  return (
    <>
      ...
      <div className="flex fixed bg-white top-0 py-2 px-4 w-full justify-between items-center border-b">
        <div
          className="flex items-center font-semibold text-theme-color"
      ...
      <p className="text-dark fixed top-2 left-1/2 -translate-x-1/2 text-mediumSubheading font-semibold">
        All Meetings
      </p>
        ...
        <div className=" w-full grid grid-cols-1 md:grid-cols-[repeat(auto-fit,_minmax(26.563rem,_1fr))] gap-4 place-items-center">
          {Array.from({ length: 6 }, (_, index) => (
            <div
              ...
              onClick={() => navigate(`/home/meeting-details/${index}`)}
            >
