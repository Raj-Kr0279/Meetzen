...
const PdfAgenda = () => {
    ...
    return (
        ...
        {annexModal && <AnnextureModal modal={annexModal} setModal={setAnnexModal}/>}
            ...
            <p className='text-dark fixed z-20 top-4 left-1/2 -translate-x-1/2 text-mediumSubheading font-semibold'>Meeting WorkSpace</p>


            <div className="flex flex-col gap-4 mt-20 px-10">
                <div className="flex justify-between w-full gap-4 items-center">
                    <div className='flex w-full border border-borderInput rounded-md p-1 gap-2 '>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center bg-hover-bg py-2 p-3 rounded-sm`}><FiFile className=' text-mediumHeading'/><span className='text-prof text-medium font-medium'>Notes</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center ${annexModal ? "bg-pdfActive" : "bg-hover-bg"} py-2 p-3 rounded-sm`} onClick={()=>setAnnexModal(true)}><MdOutlineAttachFile className=' text-mediumHeading' /><span className='text-prof text-medium font-medium'>Attachments</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center bg-hover-bg py-2 p-3 rounded-sm`}><img src={annot} className=' text-mediumHeading' /><span className='text-prof text-medium font-medium'>Annotations</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center bg-hover-bg py-2 p-3 rounded-sm`}><FiStar className=' text-mediumHeading' /><span className='text-prof text-medium font-medium'>Favourites</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center ${isChat ? "bg-pdfActive" : "bg-hover-bg"}  py-2 p-3 rounded-sm`} onClick={()=>setChat(!isChat)}><FiMessageSquare className='text-mediumHeading' /><span className='text-prof text-medium font-medium'>Chat</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center bg-hover-bg py-2 p-3 rounded-sm`}><FiZoomIn className=' text-mediumHeading' /><span className='text-prof text-medium font-medium'>Zoom In</span></h3>
                        <h3 className={`flex text-theme-color cursor-pointer gap-2 items-center bg-hover-bg py-2 p-3 rounded-sm`}><FiZoomOut className=' text-mediumHeading' /><span className='text-prof text-medium font-medium'>Zoom Out</span></h3>
                    </div>
                    <span className='text-theme-color font-medium text-medium'>1/40</span>
                </div>
...
{  !isChat &&                  <div className="w-56 shrink-0">
                        ...
                        <ul className="flex flex-col gap-2 pt-2">
                            <li className='text-base list-none text-dark font-semibold'>Section 1
                                <ul>
                    ...
                    <div className="chat__user__header flex px-8 border-b border-borderInput py-4 items-center">
                    ...
                    <div className="chat__area flex flex-col gap-5 h-[75vh] overflow-y-auto break-words py-6 px-8">
                        <div className='flex w-[85%] items-start mb-auto'>
                            ...
                            <div className=' mx-4'>
                                <p className='bg-white font-normal text-smallSubheading  text-dark p-4 rounded-[10px_10px_3px_10px] '>Id ultricies quis ipsum eu nibh ullamcorper pharetra velit orci. Nulla nunc augue in sit. Nulla ultrices adipiscing turpis placerat in tempor sagittis tortor.</p>
                    ...
                    <div className="flex w-full py-4 px-8 bg-chatInput items-center gap-4">
                        ...
                        <div className='relative w-full'>
                            ...
                            <input placeholder="Write your message here..." className='w-full border text-dark border-topSearch rounded-md py-3 px-8' type="text" name="search" id="search" />
                        </div>
                    </div>
