...
const AnnextureModal = ({ setModal }) => {
    return (
        <>
            <div className="fixed z-50 top-0 left-0 w-full h-screen bg-overlay" ></div>
            <div className="absolute w-[50vw] bg-surface z-60 top-1/2 bg-hover-bg left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-md p-6">
