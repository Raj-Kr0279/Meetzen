  ...
  return (
    ...
    <div className='w-full justify-self-start pr-20'>
      <div className='flex flex-col w-full gap-6 lg:gap-2'>
        <div>
          <label htmlFor="name" className='text-primary text-base  font-semibold inline-block pb-2'>Full Name</label>
        ...
        <div>
          <label htmlFor="phone" className='text-primary text-base  font-semibold inline-block pb-2'>Mobile Number (WhatsApp Preferred)</label>
        ...
        <div>
          <label htmlFor="bio" className='text-primary text-base  font-semibold inline-block pb-2'>Bio</label>
        ...
        <div>
          <label htmlFor="bio" className='text-primary text-base  font-semibold inline-block pb-2'>Members of Committee</label>
          <textarea disabled className=' bg-transparent border-border-input resize-none h-28 placeholder:text-placeholder w-full font-normal border-1 text-base  focus-within:border-dark focus-within:outline-none py-3 px-4 rounded-md' />
        </div>
