    ...
    return (
        <>
            ...
            <div className="absolute w-[50vw]  z-30 top-1/2 bg-hover-bg left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-md p-6">
                <AiOutlineClose className='cursor-pointer absolute top-4 right-4 text-[#ccc] text-large z-30' onClick={() => setModal(false)}/>
                <h1 className='text-prof font-semibold text-large pb-3'>Minutes of Previous meeting</h1>
