        ...
        <>
            ...
            <div className="h-[60vh] flex flex-col">
                <div className='flex bg-hover-bg py-4 justify-between shadow-meetModal rounded-md mb-4 items-start'>
                    <div className="">
                        <h1 className='text-display-md font-display pb-1.5'>132nd Meeting of Board Committee</h1>
                    ...
                    <div className="flex gap-3 items-center">
                        ...
                        <Button variant="primary" label="Submit" onClick={()=>navigate("/home/draft-minutes")}/>
                    </div>
                </div>
