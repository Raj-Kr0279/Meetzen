...
const PdfAgenda = () => {
    ...
    return (
        ...
        {annexModal && <AnnextureModal modal={annexModal} setModal={setAnnexModal}/>}
            ...
            <p className='text-primary fixed z-20 top-4 left-1/2 -translate-x-1/2 text-mediumSubheading font-semibold'>Meeting WorkSpace</p>
...
{  !isChat &&                  <div className="w-56 shrink-0">
                        ...
                        <ul className="flex flex-col gap-2 pt-2">
                            <li className='text-base list-none text-primary font-semibold'>Section 1
                                <ul>
                    ...
                    <div className="chat__area flex flex-col gap-5 h-[75vh] overflow-y-auto break-words py-6 px-8">
                        <div className='flex w-[85%] items-start mb-auto'>
                            ...
                            <div className=' mx-4'>
                                <p className='bg-white font-normal text-xs  text-primary p-4 rounded-[10px_10px_3px_10px] '>Id ultricies quis ipsum eu nibh ullamcorper pharetra velit orci. Nulla nunc augue in sit. Nulla ultrices adipiscing turpis placerat in tempor sagittis tortor.</p>
