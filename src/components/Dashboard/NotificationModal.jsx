...
const NotificationModal = ({ isNotificationsModal, setIsNotificationsModal }) => {
    ...
    return (
        <div className="absolute z-10 gap-4 tracking-[.18px] flex-col flex bg-white w-[25vw] h-[30vh] right-16 top-20 rounded-2xl shadow-md p-4">
            {/* <AiFillCloseCircle className='text-primary cursor-pointer text-heading absolute right-4 top-4' onClick={() => setIsNotificationsModal(false)} /> */}

            <div className="flex justify-between items-center">
                <h1 className='text-foreground font-semibold'>Notifications</h1>
                <span className='underline text-smallSubheading cursor-pointer text-primary font-medium' onClick={viewAllClick}>View all</span>
            </div>
            ...
            <div className="overflow-y-scroll grow-1 noti__wrapper">
                <div className="flex flex-col mb-2 break-words bg-hover-bg border-l-4 p-2 border-theme-color">
                    <h1 className='text-foreground text-base font-semibold'>80th Meeting of Board Committee</h1>
                    ...
                    <p className=' text-smallCaption text-primary font-semibold'>July 23, 2023 at 05:45 PM</p>
                </div>
