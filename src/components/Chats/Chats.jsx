...
const Chats = () => {
    ...
    return (
        <>
            ...
            <p className='text-dark leading-[1.2] fixed top-2 left-1/2 -translate-x-1/2 text-mediumSubheading font-semibold'>Chat</p>
            ...
            <div className="flex w-full mt-[40px] twok:mt-[60px] max-h-[calc(100dvh-40px)] overflow-hidden px-4">
