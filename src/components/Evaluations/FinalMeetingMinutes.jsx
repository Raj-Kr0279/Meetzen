...
const FinalMeetingMinutes = () => {
    ...
    return (
        <>
            ...
            <p className='text-dark fixed top-2 left-1/2 -translate-x-1/2 text-mediumSubheading font-semibold'>Evaluation & Service</p>
            ...
            <div className="w-full px-10 mt-[40px] twok:mt-[60px] max-h-[calc(100dvh-40px)] flex flex-col h-screen overflow-y-scroll">
                ...
                <div className=' bg-hover-bg px-4 py-4  flex justify-between rounded-md mt-6 mb-4 items-center'>
                    <div className="">
                        <p className=' text-pargraph text-theme-color leading-none font-normal pb-2'>Director Evaluation | Board of Directors</p>
                        <h1 className='text-dark font-semibold text-large'>All Evaluations</h1>
                        <p className='text-paragraph font-medium text-light' >Evaluation for: <span className='text-theme-color text-mediumCaption font-semibold pl-1'>MR. RAMCHARAN DAS</span></p>
                        <p className='text-paragraph font-medium text-light' >Financial Year: <span className='text-theme-color text-mediumCaption font-semibold pl-1'>2023</span></p>
                    </div>
...
export default FinalMeetingMinutes
