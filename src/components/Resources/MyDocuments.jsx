...
const MyDocuments = () => {
  ...
  return (
    <>
      {shareModal && (
        <ShareDocModal modal={shareModal} setModal={setShareModal} />
      )}
      {successModal && (
        <SuccessModal modal={successModal} setModal={setSuccessModal} />
          ...
          <div className="flex flex-col lg:flex-row gap-2">
            ...
            <div className="self-start basis-80">
              <div
                class={`mx-auto min-h-[250px] cursor-pointer flex gap-8 h-full aspect-square w-full max-w-lg flex-col ${files.length > 0 ? "justify-between" : "justify-center"} rounded-xl border-2 border-dashed border-border bg-white p-6 text-center`}
              >
                <label
                ...
                >
                  ...
                  <p class="pt-0.5 text-gray-500 tracking-wide">
                ...
                {files && files.length > 0 ? (
                  <div className="flex grow-1 overflow-y-auto w-full flex-col gap-2">
                    {files &&
                      files.map((v, index) => (
                        <div
                          className="flex w-full justify-between text-start items-center"
                          key={index}
                          alt=""
                        >
                          ...
                          <div className="flex w-4/12 items-center gap-2">
                            <div className="flex items-center border rounded-sm py-1 px-2">
                              <span className="text-primary text-xs font-normal">
                                {Math.floor((v.size / 1024 / 1024) * 100) /
                                  100 +
                                  " Mb"}
                              </span>
                            </div>
                    ...
                    <button
                      className="bg-primary w-full text-white py-3 rounded-md px-8 mt-2"
